                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">Quản Lý Giày</a></li>
        ...
        <a class="btn btn-primary" href="addShoe.php" role="button">Thêm Giày</a>
          <table id="tableShoe">
            <tr>
              ...
              <th class="text-center" style="min-width:100px">Update Post</th>
              <th class="text-center" style="min-width:100px">Delete Post</th>
            </tr>
            <?php
